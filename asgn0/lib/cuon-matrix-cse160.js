...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        let v3 = new Vector3([crossX, crossY, crossZ]); // Modify this line to calculate cross product between other1 and other2.
    ...
    magnitude() {
        // Insert your code here.
        let m = ((this.elements[0]**2) + (this.elements[1]**2) + (this.elements[2]**2)) ** 0.5; 
        // Modify this line to calculate this vector's magnitude.
